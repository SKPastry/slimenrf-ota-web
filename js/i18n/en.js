...
export default {
  ...
  receiver: {
    ...
    flashFirst: 'Flash receiver via UF2/DFU first',
    querying: 'Querying…',
    enterDfu: 'Enter DFU',
  ...
  update: {
    ...
    receiverAclBlocked: 'Receiver has nRF5 OpenDFU bootloader — self-OTA blocked by ACL flash protection. Use Serial DFU below or SWD.',
